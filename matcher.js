...
const SYNONYMS = {
  ...
  公司相关资料: ['宣传部'], 公司介绍: ['宣传部'], 公司简介: ['宣传部'], 公司材料: ['宣传部'],
  公司文档: ['宣传部'], 投标资料: ['宣传部'], 合作资料: ['宣传部'], 对外资料: ['宣传部'],
  // 宣传部 6 大板块（截图通讯录）
  展会资料: ['宣传部'], 参展: ['宣传部'], 展会: ['宣传部'], 展位: ['宣传部'], 展商: ['宣传部'],
  Google: ['宣传部'], google: ['宣传部'], Google后台: ['宣传部'], 后台数据: ['宣传部'], Google数据: ['宣传部'],
  公司后台: ['宣传部'], 商家数据: ['宣传部'], 商家后台: ['宣传部'],
  网站后台: ['宣传部'], 官网数据: ['宣传部'], 官网: ['宣传部'], 官网流量: ['宣传部'], 流量数据: ['宣传部'],
  部门PPT: ['宣传部'], 部门介绍: ['宣传部'], 汇报PPT: ['宣传部'], 汇报材料: ['宣传部'], 部门汇报: ['宣传部'], 演示资料: ['宣传部'],
  公司装修: ['宣传部'], 装修资料: ['宣传部'], 装修: ['宣传部'], 装修文件: ['宣传部'], 装修历史: ['宣传部'],
  // 人事部 板块名直接当关键词
...
const DEPT_ALIAS_ENTRIES = {
  ...
  '人事部': ['人事'],
  '销售秘书处': ['销售秘书', '秘书处', '秘书'],
  '宣传部': ['宣传', '宣传部', '文化墙', '宣传物料', '公司资料', '公司相关资料', '公司介绍', '公司简介', '公司材料', '公司文档', '投标资料', '合作资料', '展会资料', '参展', 'Google', '后台数据', '网站后台', '官网', '部门PPT', 'PPT', '部门汇报', '演示资料', '公司装修', '装修', 'Yuna', 'yuna', 'Hana', 'hana'],
};
const DEPT_ALIAS = {};
